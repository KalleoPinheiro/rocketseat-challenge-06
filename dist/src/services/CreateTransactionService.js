...
var CreateTransactionService = /** @class */ (function () {
    ...
    CreateTransactionService.prototype.execute = function (_a) {
        var title = _a.title, value = _a.value, type = _a.type, category_id = _a.category_id;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, transactionRepository.create({
                                title: title,
                                value: value,
                                type: type,
...
exports.default = new CreateTransactionService();
